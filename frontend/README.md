...
| Path | Surface |
| --- | --- |
| `/login` | Clearance gate inside the intelligence field |
| `/` | 3D analytics universe + holographic HUD |
| `/ask` | AI cockpit with processing pipeline |
| `/capabilities` | Orbiting capability galaxy from `GET /ai/capabilities` |