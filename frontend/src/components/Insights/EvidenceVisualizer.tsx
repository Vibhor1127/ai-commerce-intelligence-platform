    ...
    <ChartBox height={210}>
      <ResponsiveContainer>
        <PieChart>
          ...
          <Tooltip contentStyle={TOOLTIP} formatter={(value, name) => [inr(value), String(name)]} />
        </PieChart>
      </ResponsiveContainer>
    </ChartBox>
  )
    ...
    <ChartBox>
      <ResponsiveContainer>
        <LineChart data={data}>
          ...
          <Tooltip contentStyle={TOOLTIP} formatter={(value) => [inr(value), 'Revenue']} />
          <Line type="monotone" dataKey="value" stroke="#00F5FF" strokeWidth={1.8} dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </ChartBox>
  )
